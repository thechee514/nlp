...
# only use first 100 articles for testing purposes
# wiki = PlaintextCorpusReader(corpus_root, 'doc00.*\.txt')

## example retrieval
idf_index = create_idf_index (wiki)
pretty_print_results ( retrieve("president united states", wiki, idf_index), wiki)
